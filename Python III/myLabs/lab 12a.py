"""
Add a method to your code to override the default __str__ hidden method
    This method requires that the object returned must be a string
    The new method should return, in printable form, the name associated with the account and balance
"""
